...
## 57. 插入区间
![](../pic/simpleAlgorithmThree/insert.png)
```
/**
 * 57. 插入区间
 * @param {number[][]} intervals
...
## 58. 最后一个单词的长度
![](../pic/simpleAlgorithmThree/lengthOfLastWord.png)
```
/**
 * 58. 最后一个单词的长度
 * @param {string} s
...
## 62. 不同路径
![](../pic/simpleAlgorithmThree/uniquePaths.png)
```
/**
 * 62. 不同路径
 * @param {number} m
...
## 64. 最小路径和
![](../pic/simpleAlgorithmThree/minPathSum.png)
```
/**
 * 64. 最小路径和
 * @param {number[][]} grid
...
## 67. 二进制求和
![](../pic/simpleAlgorithmThree/addBinary.png)
```
/**
 * 67. 二进制求和
 * @param {string} a
...
## 69. Sqrt(x)
![](../pic/simpleAlgorithmThree/mySqrt.png)
```
/**
 * 69. Sqrt(x)
 * @param {number} x
